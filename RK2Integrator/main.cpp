...
// P is integrated by RungeKutta method whereas, E is integrated us ing Euler method
...
void main()
{
	...
	window = glfwCreateWindow(800, 800, "RK2 Integrator", nullptr, nullptr);

	std::cout << "\n This is a demonstration\/comparison of the two types of integrator.\n\n\n\n\n";
	std::cout << "Use \"Space\" to move ahead by 1 timestep. The red line is calculated using RK2 and the blue is done using euler integrator.";
